...
mass = Ωm*ϱ*boxsize**3/(N + N_fluidelements) # Mass of individual particles and fluid elements
...
component = Component('control particles', 'dark matter particles', N, mass)
...
component.populate(ones(N)*speed*mass*a_begin, 'momx')  # p = u*m*a
